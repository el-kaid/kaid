    ...
    return (
        <div className="bg-onyx text-soft-white font-montserrat">
            <section className="horizontal-scroll-wrapper relative bg-onyx min-h-screen md:h-screen overflow-hidden">
                {/* Title */}
                <div className="absolute top-24 sm:top-32 md:top-40 lg:top-44 left-0 right-0 z-20 px-6 md:px-[10vw] pointer-events-none">
                ...
                {/* Progress bar */}
                <div className="absolute top-[45%] sm:top-[50%] md:top-[55%] left-0 right-0 w-full z-30 pointer-events-none px-6 md:px-[10vw]">
                ...
                <div className="horizontal-container flex h-full">
                    {steps.map((step, index) => (
                        ...
                        >
                            <div className="max-w-2xl mt-48 lg:mt-72">
                                <h3 className="text-4xl sm:text-5xl md:text-6xl font-medium mb-6 text-white tracking-tight">
                                    {step.title}
                                </h3>
