    ...
    <footer className="bg-black text-white relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 sm:gap-10 md:gap-12">
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2 sm:space-y-3">
              ...
              <li>
                <Link to="/documentation" className="text-sm sm:text-base text-gray-300 hover:text-purple-400 transition-colors uppercase">
                  DOCUMENTATION
                </Link>
              </li>
              <li>
                <Link to="/contact" className="text-sm sm:text-base text-gray-300 hover:text-purple-400 transition-colors uppercase">
                  CONTACT US
                </Link>
              </li>
            </ul>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2 sm:space-y-3">
              <li>
                <Link to="/blog" className="text-sm sm:text-base text-gray-300 hover:text-purple-400 transition-colors uppercase">
                  BLOG
                </Link>
              </li>
              <li>
                <Link to="/privacy-policy" className="text-sm sm:text-base text-gray-300 hover:text-purple-400 transition-colors uppercase">
                  PRIVACY POLICY
                </Link>
              </li>
              <li>
                <Link to="/terms-of-service" className="text-sm sm:text-base text-gray-300 hover:text-purple-400 transition-colors uppercase">
                  TERMS OF SERVICE
                </Link>
              </li>
            </ul>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12 py-8 sm:py-10">
        ...
        <div className="flex justify-center items-center gap-4 sm:gap-6 mb-6 sm:mb-8">
          <button
            type="button"
            className="w-10 h-10 sm:w-12 sm:h-12 border-2 border-gray-700 rounded-full flex items-center justify-center text-gray-300 hover:border-purple-500 hover:text-purple-400 hover:bg-purple-500/10 transition-all duration-300 group cursor-pointer bg-transparent"
            aria-label="Facebook"
          >
          ...
          <button
            type="button"
            className="w-10 h-10 sm:w-12 sm:h-12 border-2 border-gray-700 rounded-full flex items-center justify-center text-gray-300 hover:border-cyan-500 hover:text-cyan-400 hover:bg-cyan-500/10 transition-all duration-300 group cursor-pointer bg-transparent"
            aria-label="Twitter"
          >
          ...
          <button
            type="button"
            className="w-10 h-10 sm:w-12 sm:h-12 border-2 border-gray-700 rounded-full flex items-center justify-center text-gray-300 hover:border-pink-500 hover:text-pink-400 hover:bg-pink-500/10 transition-all duration-300 group cursor-pointer bg-transparent"
          ...
          <button
            type="button"
            className="w-10 h-10 sm:w-12 sm:h-12 border-2 border-gray-700 rounded-full flex items-center justify-center text-gray-300 hover:border-blue-500 hover:text-blue-400 hover:bg-blue-500/10 transition-all duration-300 group cursor-pointer bg-transparent"
            aria-label="LinkedIn"
          >
