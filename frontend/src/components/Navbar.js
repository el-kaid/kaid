...
const Navbar = () => {
    ...
    return (
        <nav className={`fixed top-12 left-0 right-0 z-50 transition-all duration-500 ease-in-out mix-blend-difference text-white ${isVisible ? 'translate-y-0' : '-translate-y-full'
            }`}>
